<template>
  <span>
    <span class="whole">
      <input type="text" size="1" v-once :value="whole" @change="input($event,'whole')">
    </span>
    <span class="frac">
      <span class="num"  >
        <input type="text" size="1" v-once :value="value.num" @input="input($event,'num')">
      </span>
      <span class="denom">
        <input type="text" size="1" v-once :value="value.denom" @input="input($event,'denom')">
      </span>
    </span>
